...
class TOC(Form):
    Agency= TextField('')
    kill = IntegerField('')
    DashboardQuestion = IntegerField('')
    DashboardReportSort = IntegerField('')
    DorR =TextField('')
    DashboardReport = TextField('')
    SystemofCare = TextField('')
    ServiceArea = TextField('')
    Description = TextAreaField('')
    Purpose =TextAreaField('')
    iddeid =TextAreaField('')
    TargetedAudience =TextAreaField('')
    Supportswhichmeeting = IntegerField('')
    Ready = IntegerField('')
    Link =TextAreaField('')
